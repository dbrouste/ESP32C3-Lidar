...
class TFMPlus
{
  public:
    ...
    void printReply();    
    bool getResponse();
    void init(int lidarId, boolean hightRate, int rx, int tx);

  private:
    Stream* pStream[2];      // pointer to the device serial stream
    ...
    void printStatus();
    void setHightBaudRate();

};

#endif

void InitTFMPlus (void);